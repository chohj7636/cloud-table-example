...
const mockClouds: CloudTable[] = [
  {
    ...
    cloudGroupName: ['production', 'web-services', 'critical'],
  ...
  },
  {
    ...
    cloudGroupName: ['production', 'enterprise'],
    eventProcessEnabled: true,
    userActivityEnabled: true,
  ...
  },
  {
    ...
    cloudGroupName: ['development', 'non-prod'],
    eventProcessEnabled: false,
    userActivityEnabled: false,
  ...
  },
  {
    ...
    cloudGroupName: ['production', 'ml-services'],
    eventProcessEnabled: true,
    userActivityEnabled: true,
